...
hparams = tf.contrib.training.HParams(
	...
	tacotron_test_size = 0.1, #% of data to keep as test data, if None, tacotron_test_batches must be not None
	...
	'vi har ju gjort en motsvarande upptäckt på hemmaplan.',
	'du måste alltid tro på att du kan.',
	'de berörda passagerarna har erbjudits pengarna tillbaka eller ombokningar.',
	'att vara en god gäst är den bästa gåvan till sommarens alla fester.',
	'det är en dröm man haft sedan man var liten.',
	'skatterna sänktes något på inkomster mellan 30000 och 50000 kronor i månaden.',
	'jag har till och med sett någon ridskola som har ordnat en krisfond.',
	'barn som skriker efter mer godis.',
	'för tre år sedan spelade jag i superettan och nu spelar jag i premier league.',
	'glad och lagom tacksam är den goda gästens viktigaste budord.',
	'konspirationsteorin bygger på att utredningen om rysslands inblandning i det amerikanska presidentvalet bara är en front.',
	'avdraget reducerar skatten på lön och näringsverksamhet.',
	'vill du uppleva hur evig tacksamhet känns så anmäl dig att passa eventuella barn.',
	'med hjälp av statistiska metoder går det att analysera vilken betydelse sådana faktorer har.',
	'en annan aspekt som kan vara intressant att studera är marginalskatten.',
	'det skulle i praktiken kunna betyda att 20 miljoner lagliga invandrare utvisas.',
	'det beror på att man vill undvika att allt fler med automatik får betala statlig skatt.',
	]
